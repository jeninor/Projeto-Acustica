...
3. CF2 real loudspeaker directivity via CF2SevenBandDirectivity
...
def main():
    ...
    ap.add_argument(
        "--output-dir",
        default="/app/results/multiband_directivity_benchmark",
    )
    ...
    print(
        "=== Stage-2 Pyroomacoustics multiband directivity benchmark ==="
    )
    ...
    cf2_directivity = CF2SevenBandDirectivity(
        cf2_path=args.cf2,
